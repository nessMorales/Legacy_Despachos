#############################################################################
# Makefile for building: despachosII
# Generated by qmake (2.01a) (Qt 4.8.5) on: mar. 24. mar. 20:23:05 2020
# Project:  despachosII.pro
# Template: app
# Command: c:\qt\4.8.5\bin\qmake.exe -spec c:\Qt\4.8.5\mkspecs\win32-g++ CONFIG+=release -o Makefile despachosII.pro
#############################################################################
...
Makefile: despachosII.pro  c:/Qt/4.8.5/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.5\mkspecs\win32-g++ CONFIG+=release -o Makefile despachosII.pro
